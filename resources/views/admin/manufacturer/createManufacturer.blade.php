...
<div class="panel panel-success">
    ...
    <div class="form-group">
            <div class="input-group has-success col-md-12">  
                    ...
                    <input type="text" id="catname" name="manufacturerName" class="form-control" placeholder="Enter Manufacturer Name" > 
            </div>      
        ...
        <div class="form-group">
            <div class="input-group has-success col-md-12">  
                    ...
                    <textarea name="manufacturerDescription" id="catdescription" cols="16" rows="4"  class="form-control" placeholder="Manufacturer Description" ></textarea>  
            </div>     
