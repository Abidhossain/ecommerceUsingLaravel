                        ...
                        <div class="col-md-3 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img height="200px" width="200px" src="{{asset($product->productImage)}}" alt="" class="pro-image-front">
                                    <img height="200px" width="200px" src="{{asset($product->productImage)}}" alt="" class="pro-image-back">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
        <a href="{{url('/productDetails/'.$product->id)}}" class="link-product-add-cart">Quick View</a>
                                            </div>
                                        </div>
                                ...
                                <div class="item-info-product ">
                                    <h4><a href="{{url('/productDetails/'.$product->id)}}">{{$product->productName}}</a></h4>
                                    <div class="info-product-price">
                                        <span class="item_price">
                                            <?php 
                                                echo 'Tk.'. number_format($product->productPrice,2);
                                            ?>    
                                        </span> 
                                    </div>
                                    <a href="{{url('/productDetails/'.$product->id)}}" class="item_add single-item hvr-outline-out button2">Add to cart</a>									
                                </div>
                            </div>
                        </div> 
                        @endforeach
                    ...
                    <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
                        <div class="col-md-3 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('public/assets/images/w1.png')}}" alt="" class="pro-image-front">
                                    <img src="{{asset('public/assets/images/w1.png')}}" alt="" class="pro-image-back">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                        ...
                        <div class="col-md-3 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('public/assets/images/w2.png')}}" alt="" class="pro-image-front">
                                    <img src="{{asset('public/assets/images/w2.png')}}" alt="" class="pro-image-back">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="single.html" class="link-product-add-cart">Quick View</a>
                                            </div>
                    ...
                    <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
                        <div class="col-md-3 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('public/assets/images/g1.png')}}" alt="" class="pro-image-front">
                                    <img src="{{asset('public/assets/images/g1.png')}}" alt="" class="pro-image-back">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="single.html" class="link-product-add-cart">Quick View</a>
                                            </div>
                        ...
                        <div class="col-md-3 product-men yes-marg">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('public/assets/images/w4.png')}}" alt="" class="pro-image-front">
                                    <img src="{{asset('public/assets/images/w4.png')}}" alt="" class="pro-image-back">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="single.html" class="link-product-add-cart">Quick View</a>
                                            </div>
                        ...
                        <div class="col-md-3 product-men yes-marg">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('public/assets/images/w3.png')}}" alt="" class="pro-image-front">
                                    <img src="{{asset('public/assets/images/w3.png')}}" alt="" class="pro-image-back">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="single.html" class="link-product-add-cart">Quick View</a>
                                            </div>
