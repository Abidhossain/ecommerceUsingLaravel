...
@section('title','Category | Ecommerce')
@section('mainContent')
...
<div class="men-wear">
	<div class="container">
		<div class="col-md-4 products-left">
			...
			<div class="css-treeview">
				...
				<ul class="tree-list-pad">
					<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Mens Wear</label>
						<ul>
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-bottom">
				...
				<div class="col-sm-8 men-wear-right">
					<h4>Exclusive Mens Collections</h4>
		...
		<div class="single-pro">
			@foreach($publishedCategoryProduct as $categoryProduct)
		<div class="col-md-3 product-men yes-marg">
			<div class="men-pro-item simpleCart_shelfItem">
				<div class="men-thumb-item">
					<img height="200px" width="200px" src="{{asset($categoryProduct->productImage)}}" alt="" class="pro-image-front">
					<img height="200px" width="200px" src="{{asset($categoryProduct->productImage)}}" alt="" class="pro-image-back">
						<div class="men-cart-pro">
							<div class="inner-men-cart-pro">
								<a href="{{url('/productDetails/'.$categoryProduct->id)}}" class="link-product-add-cart">Quick View</a>
							</div>
						</div>
						<span class="product-new-top">New</span>
				...
				<div class="item-info-product ">
					<h4><a href="single.html">{{$categoryProduct->productName}}</a></h4>
					<div class="info-product-price">
						<span class="item_price">
							<?php 
								echo  'TK: '.number_format($categoryProduct->productPrice,2)
							?> 
						</span>
					</div>
					<a href="#" class="item_add single-item hvr-outline-out button2">Add to cart</a>									
